...
public final class EnvironmentVariables {
    ...
    public static String AWS_ENDPOINT = "AWS_ENDPOINT";
    public static String S3_ENDPOINT = "S3_ENDPOINT";
    public static String S3_DISABLE_SSL = "S3_DISABLE_SSL";
    public static String S3_FORCE_PATH_STYLE = "S3_FORCE_PATH_STYLE";
}
